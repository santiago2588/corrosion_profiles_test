...
def run():
    ...
    if add_selectbox == 'Individual':
        ...
        magnessium = st.slider(label = 'Magnesio_ppm', min_value = 0,
                          max_value = 5000,
                          value = 500,step=1)
        ...
        features = {'BOPD': BOPD, 'BWPD': BWPD,
            ...
            'Magnesio_ppm': magnessium, 'Calcio_ppm': calcium,
        ...
        if st.button('Predecir'):
            ...
            temp_array,press_array,depth_array,fy_df,ph_df,nk_df,corr_profile_risk = grahpNorskok(temperature_head,
               temperature_bottom,pressure_head,pressure_bottom,BOPD,BWPD,MSCF,co2_frac,alkalinity,
            ...
            calcite_si_temp, solid_temp,scale_risk_temp=calCalcite(pressure_head,
               ...
               alkalinity,co2_frac,carb_acids,BOPD,
               BWPD,MSCF,"CABEZA")
            ...
            temp_array, press_array, depth_array, fy, ph1, calcite, ptb1,scale_profile_risk=graphCalcite(temperature_head,
                ...
                well_depth,BOPD,BWPD,MSCF,co2_frac,alkalinity,
            ...
            fig_corr=px.line(well_corr1,x='Profundidad [ft]',y='Velocidad de corrosion (mpy)',title='Perfil de velocidad de corrosion',
            ...
            fig_sca=px.line(well_scale3,x='Profundidad [ft]',y='Indice de saturacion calcita',title='Perfil del indice de saturacion',
